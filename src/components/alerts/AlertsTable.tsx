              ...
              <TableHeader>
                <TableRow>
                  <TableHead 
                    ...
                    onClick={() => setSortBy(sortBy === 'ticker_asc' ? 'ticker_desc' : 'ticker_asc')}
                  >
                    Ticker {sortBy.includes('ticker') && (sortBy.includes('asc') ? '↑' : '↓')}
                  </TableHead>
                  ...
                  >
                    Price {sortBy.includes('price') && (sortBy.includes('asc') ? '↑' : '↓')}
                  </TableHead>
                  <TableHead>Timeframe</TableHead>
                  <TableHead 
                    className="cursor-pointer hover:bg-muted/50"
                    onClick={() => setSortBy(sortBy === 'timestamp_asc' ? 'timestamp_desc' : 'timestamp_asc')}
                  >
                    Full Date {sortBy.includes('timestamp') && (sortBy.includes('asc') ? '↑' : '↓')}
                  </TableHead>
