  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 p-6 rounded-xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 text-white shadow-lg">
        <div>
          <h1 className="text-3xl font-bold text-white drop-shadow-md">🎯 Trading Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card className="border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/30 dark:to-emerald-800/30 shadow-lg hover:shadow-xl transition-shadow">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-700 dark:text-green-300 font-medium">📈 Market Data</p>
        ...
        <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-800/30 shadow-lg hover:shadow-xl transition-shadow">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-blue-700 dark:text-blue-300 font-medium">🎮 Trading Playground</p>
        ...
        <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-100 dark:from-purple-900/30 dark:to-pink-800/30 shadow-lg hover:shadow-xl transition-shadow">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-purple-700 dark:text-purple-300 font-medium">👑 Plan Status</p>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4 bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900/50 dark:to-purple-900/50 p-1">
          ...
          <TabsTrigger value="features" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-500 data-[state=active]:to-emerald-500 data-[state=active]:text-white">🎯 Features</TabsTrigger>
          <TabsTrigger value="charts" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-red-500 data-[state=active]:text-white">📈 Charts</TabsTrigger>
          <TabsTrigger value="signals" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">⚡ Signals</TabsTrigger>
        </TabsList>
          ...
          <Card className="border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/20 dark:to-green-800/20 shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-emerald-800 dark:text-emerald-100 text-xl">💰 Live Market Data</CardTitle>
          ...
          <Card className="border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-indigo-900/20 dark:to-blue-800/20 shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-indigo-800 dark:text-indigo-100 text-xl">🚀 Trading Signals Platform</CardTitle>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-6 rounded-xl border-2 border-yellow-200 bg-gradient-to-br from-yellow-50 to-orange-100 dark:from-yellow-900/30 dark:to-orange-800/30 shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="font-bold text-yellow-800 dark:text-yellow-100">⚡ Real-time Signals</h3>
                ...
                <div className="text-center p-6 rounded-xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/30 dark:to-emerald-800/30 shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="font-bold text-green-800 dark:text-green-100">📉 OHLC Data</h3>
                ...
                <div className="text-center p-6 rounded-xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-800/30 shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="font-bold text-blue-800 dark:text-blue-100">💹 Live Prices</h3>
              ...
              <Card className="border border">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-white">Bitcoin Technical Analysis</CardTitle>
                ...
                <Card className="border border">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-white">Ethereum Technical Analysis</CardTitle>
                ...
                <Card className="border border">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      <div className="text-2xl">◎</div>
                      <div>
                        <CardTitle className="text-white">Solana Technical Analysis</CardTitle>
              ...
              <Card className="border border">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-white dark:text-white text-xl font-bold">
                        Weekly Buy/Sell Signals - Past 2 Years
                      </CardTitle>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4">
                      <div className="p-4 rounded-lg bg-muted/50 border">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-sm text-blue-200 dark:text-blue-200 font-semibold">Total Buy Signals</p>
                            <p className="text-2xl font-bold text-white dark:text-white">1,247</p>
                          </div>
                      ...
                      <div className="p-4 rounded-lg bg-muted/50 border">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-sm text-blue-200 dark:text-blue-200 font-semibold">Total Sell Signals</p>
                            <p className="text-2xl font-bold text-white dark:text-white">1,189</p>
                          </div>
                      ...
                      <div className="p-4 rounded-lg bg-muted/50 border">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-sm text-blue-200 dark:text-blue-200 font-semibold">Success Rate</p>
                            <p className="text-2xl font-bold text-white dark:text-white">73.4%</p>
                          </div>
                    ...
                    <div className="lg:col-span-2">
                      ...
                      <div className="space-y-3 max-h-80 overflow-y-auto">
                        {[
                          ...
                          <div key={index} className={`flex items-center justify-between p-3 rounded-lg border-2 shadow-md hover:shadow-lg transition-all transform hover:scale-102 ${
                            signal.type === 'BUY' 
                              ? 'border-green-400 bg-gradient-to-r from-green-600/30 to-emerald-600/30' 
                              : 'border-red-400 bg-gradient-to-r from-red-600/30 to-pink-600/30'
                          }`}>
                            <div className="flex items-center space-x-3">
                              <Badge 
                            ...
                            <div className="text-right">
                              <Badge variant="outline" className="border-2 border-purple-400 bg-gradient-to-r from-purple-400/20 to-pink-400/20 text-purple-100 font-bold">
                                🎯 {signal.confidence}%
                              </Badge>
                            </div>
                          </div>
              ...
              <Card className="border-2 border-cyan-400 bg-gradient-to-br from-cyan-900/80 via-blue-900/80 to-purple-900/80 shadow-2xl">
                <CardHeader className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-t-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-white font-bold drop-shadow-lg">⚡ Live Trading Signals 🚀</CardTitle>
                  ...
                  <div className="space-y-4">
                    <Alert className="border-2 border-yellow-400 bg-gradient-to-r from-orange-400/20 to-yellow-400/20 shadow-lg">
                      ...
                      <AlertDescription className="text-orange-100 font-medium">
                        ...
                        ⚠️ This data is for informational purposes only and should not be considered financial advice.
                      </AlertDescription>
                    </Alert>
                    
                    {recentSignals?.map((signal, index) => (
                      <div key={index} className={`flex items-center justify-between p-4 border-2 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105 ${
                        signal.type === 'BUY' 
                        ...
                        <div className="flex items-center space-x-4">
                          <Badge variant={signal.type === "BUY" ? "default" : "destructive"} className={`${
                            signal.type === 'BUY' 
                          ...
                          <div>
                            <h4 className="font-bold text-white drop-shadow">🪙 {signal.ticker}</h4>
                            <p className="text-sm text-cyan-200 font-semibold">
                              💰 ${signal.price.toLocaleString()} • 🕰️ {signal.timestamp}
                            </p>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="flex items-center space-x-2">
                            <span className="text-sm font-bold text-yellow-300">💪 Strength:</span>
                            <Badge variant="outline" className="border-2 border-yellow-400 bg-gradient-to-r from-yellow-400/20 to-orange-400/20 text-yellow-100 font-bold">{signal.confidence}%</Badge>
                          </div>
                        </div>
                      </div>
                    ))}
