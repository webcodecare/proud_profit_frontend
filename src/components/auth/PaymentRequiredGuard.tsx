      ...
      <Card className="max-w-2xl w-full border-2 border-dashed border-primary/30 bg-gradient-to-br from-background to-secondary/20 shadow-2xl">
        <CardHeader className="text-center pb-6">
          ...
          <CardDescription className="text-lg text-muted-foreground">
            {userTier === "free"
              ...
              : `Access to ${pageName} requires an active subscription. Your ${userTier} plan is currently ${
        ...
        <CardContent className="space-y-6">
          <div className="text-center space-y-4">
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border-2 ${getTierColor(
                requiredTier
              )}`}
            >
              {getTierIcon(requiredTier)}
          ...
          <div className="text-center space-y-4">
            <p className="text-muted-foreground">
              Upgrade your subscription to unlock premium trading features and
              advanced analytics.
            </p>
