  ...
  useEffect(() => {
    ...
    const initChart = () => {
      try {
        ...
        // Clear any existing chart with null check
    ...
    // Handle resize with enhanced null checks
    const handleResize = () => {
      if (chartContainerRef.current && chartRef.current && chartRef.current.applyOptions) {
