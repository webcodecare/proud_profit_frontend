        ...
        <div className="ml-0 lg:ml-64 flex-1">
          ...
          <header className="bg-card border-b border-border p-3 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold">Signals</h1>
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                <Button variant="outline" size="sm" className="text-xs sm:text-sm">
                  ...
                  <span className="hidden sm:inline">Alerts ({recentSignals.length})</span>
          ...
          <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
            <Tabs defaultValue="overview" className="w-full">
              <TabsList className={`grid w-full ${isAdmin ? 'grid-cols-5' : 'grid-cols-4'}`}>
                ...
                <TabsTrigger value="charts" className="flex items-center justify-center gap-1 sm:gap-2">
                  <LineChart className="h-4 w-4" />
                  <span className="hidden sm:inline">Charts</span>
                </TabsTrigger>
                <TabsTrigger value="analytics" className="flex items-center justify-center gap-1 sm:gap-2">
                  <PieChart className="h-4 w-4" />
                  <span className="hidden sm:inline">Analytics</span>
                </TabsTrigger>
                {isAdmin ? (
                  <TabsTrigger value="admin" className="flex items-center justify-center gap-1 sm:gap-2">
                    <Settings className="h-4 w-4" />
                    <span className="hidden sm:inline">Admin</span>
                  </TabsTrigger>
                ) : (
                  <TabsTrigger value="categories" className="flex items-center justify-center gap-1 sm:gap-2">
                    <TrendingUp className="h-4 w-4" />
                    <span className="hidden sm:inline">Categories</span>
                  </TabsTrigger>
                )}
                <TabsTrigger value="signals" className="flex items-center justify-center gap-1 sm:gap-2">
