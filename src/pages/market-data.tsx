    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-gradient-to-r from-background to-muted/20">
        <div className="container px-4 mx-auto">
          ...
          {/* Market Stats Cards */}
          <div className="mb-12">
            <MarketStatsGrid stats={marketStats || []} isLoading={marketStatsLoading} />
          </div>
        </div>
      </section>
              ...
              <CardContent>
                {marketStatsLoading ? (
                  ...
                  <div className="space-y-4">
                    {marketStats?.slice(0, 4).map((coin) => {
                      const isPositive = coin.changePercent.startsWith('+');
                      return (
                        <div key={coin.symbol} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
            ...
            <Card>
              ...
              <CardContent>
                {marketStatsLoading ? (
                  ...
                  <div className="space-y-4">
                    {marketStats?.slice(4, 8).map((coin) => {
                      const isPositive = coin.changePercent.startsWith('+');
                      return (
                        <div key={coin.symbol} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                          <div className="font-mono font-semibold">{coin.symbol}</div>
