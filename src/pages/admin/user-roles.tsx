...
export default function AdminUserRoles() {
  ...
  // Use real API roles data or fallback to calculated data from users
  const userRoles: UserRole[] = rolesData?.roles || [
    {
      id: 'admin',
      name: 'Administrator',
  ...
  const handleUpdateUser = () => {
    if (!selectedUser || !selectedUser.id) {
      console.error('Cannot update user: selectedUser or user ID is missing');
      return;
    }
