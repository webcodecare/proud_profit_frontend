...
export default function AdminSubscriptions() {
  ...
  const createPlanMutation = useMutation({
    mutationFn: (planData: any) => apiRequest('/api/admin/subscription-plans', {
      method: 'POST',
  ...
  const updatePlanMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: any }) => apiRequest(`/api/admin/subscription-plans/${id}`, {
      method: 'PUT',
                            ...
                            <div>
                              ...
                              <ul className="text-sm text-muted-foreground space-y-1">
                                {Array.isArray(plan.features) ? (
                                  ...
                                  <li className="text-xs text-muted-foreground">No features available</li>
                                )}
