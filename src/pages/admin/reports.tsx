...
import { BarChart3, Download, Calendar, TrendingUp, Users, DollarSign, Zap, Activity, AlertCircle } from "lucide-react";
              ...
              {error ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground text-sm mt-2">
                    {(error as any)?.message || "The reports API is not available"}
                  </p>
                </div>
              ) : isLoading ? (
                <div className="space-y-2">
